...
export const getCategoriasAction = () => async (dispatch, getState) => {
  try {
...
export const postCategoryAction = (category) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    getCategoriasAction()(dispatch, getState);
  } catch (error) {
    dispatch({
